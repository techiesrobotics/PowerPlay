...
public class PPPipeline extends OpenCvPipeline {
    ...
    static final Scalar PURPLE = new Scalar(163, 0, 163);
    static final Scalar BROWN = new Scalar(150, 75, 0);
    /*
    ...
    // default value, might delete later
    ...
    public int convert (){
        if (getAnalysis().equals(PPPipeline.FreightLocation.ONE)){
            return 1;
        }
        else if (getAnalysis().equals(PPPipeline.FreightLocation.ONE)){
            return 2;
        }
        else if (getAnalysis().equals(PPPipeline.FreightLocation.ONE)){
            return 3;
